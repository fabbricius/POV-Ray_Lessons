...
The code can be found in the makta_project.pov in the [more_tutorials folder](more_tutorials).
Here is what you will obtain: ![shapes](screenshots/makta_project_thumbnail.png)
